    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <?php if(isset($_GET['type']) && $_GET['type'] == 'objective'):?>
            ...
            <div class="input-group mb-3 ">
                ...
                <input type="text" name="correct_answer" value="<?=get_var('correct_answer', $question->correct_answer)?>" class="form-control" id="inputGroupFile011" placeholder="Enter the correct answer here">
            </div>
        <?php endif;?>
