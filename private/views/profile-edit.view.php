	...
	<div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px;">
		...
		<div class="row">
			<div class="col-sm-4 col-md-3">
				<img src="<?=$image?>" class="border d-block mx-auto shadow" style="width:150px;">
 				<br>
			...
			<div class="col-sm-8 col-md-9 bg-light p-2">
					<div class="p-4 mx-auto mr-4 shadow rounded" >
						...
						<select class="my-2 form-control" name="gender">
							<option <?=get_selected('gender',$row->gender)?> value="<?=$row->gender?>"><?=ucwords($row->gender)?></option>
						...
						<select class="my-2 form-control" name="rank">
							<option <?=get_selected('rank',$row->rank)?> value="<?=$row->rank?>"><?=ucwords($row->rank)?></option>
